...
class AwakeningATKBoostAS(ActiveSkill):
    ...
    def active_skill_type(self):
        return 'awakening_atk_boost'


# Register the active skill
SkillLoader._register_active_skill_class(AwakeningATKBoostAS)