...
class SkillParser(JsonParser):
    _skills = {
        ...
        167: _mass_match_convert({'attributes': (0,binary_to_list), 'minimum_count': (1,cc), 'minimum_atk_multiplier': (2,multiplier), 'minimum_rcv_multiplier': (3,multiplier), 'bonus_atk_multiplier': (4,multiplier), 'bonus_atk_multiplier': (5,multiplier), 'maximum_count': (6,cc)}),
