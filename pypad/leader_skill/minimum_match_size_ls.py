...
class MinimumMatchSizeLS(LeaderSkill):
    _handle_types = {158}

    def parse_args(self):
        self.minimum_match_size = self.args[0]
    ...
    def args_to_json(self):
        return {
            'minimum_match_size': self.minimum_match_size,
    ...
    def leader_skill_type(self):
        return 'minimum_match_size'


# Register the active skill
SkillLoader._register_leader_skill_class(MinimumMatchSizeLS)